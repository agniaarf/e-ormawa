...
<tr>
    ...
    <td class="text-right whitespace-nowrap">
        ...
        <?php else: ?>
            <button type="button" onclick="openDetailModal(<?= e(json_encode($row)) ?>)" title="Lihat" class="inline-flex items-center px-2 py-1.5 rounded-md bg-surface-low text-on-surface-variant hover:bg-surface-high mr-1">
