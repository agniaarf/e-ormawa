...
<tr>
    ...
    <td class="text-right whitespace-nowrap">
        <button type="button" onclick="openMemberModal(<?= e(json_encode($row)) ?>)" title="Edit" class="inline-flex items-center px-2 py-1.5 rounded-md bg-primary/10 text-primary hover:bg-primary/20 mr-1">
...
<?php if (!empty($list)): ?>
<tr><td colspan="<?= $can_manage?5:4 ?>" class="bg-white border-t border-outline-variant"><?= renderPagination($p) ?></td></tr>
<?php endif; ?>
