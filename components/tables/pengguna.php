...
<tr>
    ...
    <td class="text-right whitespace-nowrap">
        ...
        <?php else: ?>
            <button type="button" onclick="openPenggunaModal(<?= e(json_encode($row)) ?>)" title="Edit" class="inline-flex items-center px-2 py-1.5 rounded-md bg-primary/10 text-primary hover:bg-primary/20 mr-1">
