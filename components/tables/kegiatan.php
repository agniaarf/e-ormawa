...
<tr>
    ...
    <td class="text-right whitespace-nowrap">
        <a href="<?= url('organisasi/' . $org_id . '/kegiatan/' . $row['id']) ?>" title="Detail" class="inline-flex items-center px-2 py-1.5 rounded-md bg-surface-low text-on-surface-variant hover:bg-surface-high mr-1">
