...
$icn = [
    ...
    'calendar' => '<svg class="w-5 h-5" fill="none" stroke="currentColor" stroke-width="1.5" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M6.75 3v2.25M17.25 3v2.25M3 18.75V7.5a2.25 2.25 0 012.25-2.25h13.5A2.25 2.25 0 0121 7.5v11.25m-18 0A2.25 2.25 0 005.25 21h13.5A2.25 2.25 0 0021 18.75m-18 0v-7.5A2.25 2.25 0 015.25 9h13.5A2.25 2.25 0 0121 11.25v7.5m-9-3h.008v.008H12v-.008zM9 15h.008v.008H9V15zm6 0h.008v.008H15V15z"/></svg>',
...
if ($role === 'Super Admin') {
    ...
    foreach (my_organisasi((int)($_SESSION['user_id'] ?? 0)) as $o) {
        ...
        $items[] = ['label'=>'Jadwal Kegiatan','url'=>url('organisasi/'.$oid.'/jadwal'),'icon'=>$icn['calendar'],'active'=>$current==='org_jadwal' && $current_org_id===$oid];
